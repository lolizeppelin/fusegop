...
export function gopLogin(callable, model, analyzer = null, onSuccess = null, onFail = null) {

    return (dispatch) =>
        callable(model.email, model.password,
            (result) => {
                dispatch(setUserData(analyzer === null ? result : analyzer(result)));
